export default {
    ...
    details: {
      ...
      consultation: {
        ...
        consultation: {
          ...
          point_1: 'технічна консультація щодо особливостей експлуатації т/з, порядку та строках проходження ТО;',
          point_2: 'передача термінового повідомлення від Клієнта (факс, SMS-повідомлення, e-mail);',
        ...
        crash_consultation: {
          ...
          point_5: 'інформація про місцезнаходження та телефони екстрених служб;',
          point_6: 'консультації лікаря по телефону.',
        },
      },
      organization_services: {
        title: 'Організаційні послуги',
        description: 'Клієнт самостійно сплачує вартість послуг, організованих Компанією на його прохання:',
        point_1: 'виклик ДАІ;',
  ...
  questions_screen: {
    ...
    what_is_aaua: {
      ...
      description:
        'Комплексна система заходів, яка регулює взаємовідносини між Організатором та Учасниками, в рамках якої учасники мають можливість накопичувати бонуси, отримувати нагороди і скидки в результаті покупки товарів і послуг у партнерів Організатора програми.',
    },
    how_get_card: {
      header: 'Як отримати картку учасника програми «AAUA»?',
      description:
        'Пакет «Картка учасника», який містить картку і інформаційний буклет, можно отримати безкоштовно через офіційний сайт Організатора (https://www.aaua.com.ua) або через мобільний додаток «AAUA».',
    },
    card_coast: {
      header: 'Скільки коштує карта «AAUA»?',
      description:
        'Пакет «Картка учасника», який містить картку і інформаційний буклет, можно отримати безкоштовно через офіційний сайт Організатора (https://www.aaua.com.ua), купуючи товари або послуги у партнерів ассоціації або через мобільний додаток «AAUA».',
    },
    bonuses: {
    ...
    bonuses_counts: {
      ...
      description:
        'Перевірити баланс бонусів можно: - в чеку після кожної покупки на АЗК «WOG»; - в персональному кабінеті на сайті www.aaua.com.ua; - в мобільному додатку «AAUA»; - за телефоном гарячої лінії «AAUA» - 0 800 50 50 24.',
    },
    card_period: {
      header: 'Термін дії карти «AAUA»?',
      description:
        'Картка «AAUA» наобмежений термін дії. Дія картки «AAUA» може бути зупинено при відсутності будьяких операцій з використанням картки на протязі 12 місяців.',
    },
    bonuses_period: {
      header: 'Як довго бонуси можуть зберігатись на моїй картці?',
      description:
        'Бонуси зберігаються на картці учасника 1 (один) календарний рік з моменту нарахування. У випадку, якщо Учасник за будьякої причини не використав бонуси на протязі вказаного періода, їх залишок автоматично анулюється. Термін дії карти необмежений.',
    },
    bonuses_exchange: {
      header: 'На що я можу обміняти бонуси?',
      description:
        'Бонуси «WOG» можно обміняти на паливо і товари в «WOG Маркет». Бонуси «AAUA» можно обміняти на товари і послуги в мобільному додатку «AAUA».',
    },
    bonuses_wog: {
      header: 'Не можу зняти бонуси «WOG»?',
      description:
        'Для зняття бонусів «WOG» і встановлення пін-кода необхідно зареєструвати картку за телефоном: 0 800 300 525.',
    },
    how_register: {
      header: 'Як я можу зареєструватись в програмі?',
      description:
        'На офіційному сайті Организатора (https://www.aaua.com.ua) або через мобільний додаток «AAUA».',
    },
  },
  feedback_screen: {
