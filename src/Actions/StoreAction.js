...
export const getProductsByCategoriesId = (
  token,
  phone,
  categoryId,
  sortingName,
...
export const getProductById = (token, phone, productId) => {
  return dispatch => {
    ...
    const signature = encode(signatureString);
    console.log(
      'STORE get product by ID- ',
      signature,
      STORE_PRODUCT_BY_ID_URL + productId,
    );
    axios
      .get(STORE_PRODUCT_BY_ID_URL + productId, {
        headers: {
          Signature: signature,
        },
      })
...
export const increseCounter = (token, phone, productId) => {
  return dispatch => {
    ...
    const signature = encode(signatureString);
    console.log(
      'STORE increase product views counter - ',
      signature,
      STORE_PRODUCT_INCREASE_VIEWS_URL,
    );
    axios
      .post(
        STORE_PRODUCT_INCREASE_VIEWS_URL + productId,
        {},
        {
          headers: {
            Signature: signature,
...
export const makeOrder = (user, basket, orderData, orderType) => {
  return () => {
    ...
    axios
      .post(STORE_MAKE_ORDER_URL, data, {
        headers: {
          Signature: signature,
...
export const getHistory = user => {
  return dispatch => {
    ...
    console.log(
      'STORE get history - ',
      signature,
      STORE_HISTORY_URL + user.profile.id,
    );
    axios
      .get(STORE_HISTORY_URL + user.profile.id, {
        headers: {
          Signature: signature,
        },
      })
...
export const getOrderDetails = (user, orderId) => {
  return dispatch => {
    ...
    console.log(
      'STORE get products - ',
      signature,
      STORE_ORDER_DETAILS_URL + orderId,
    );
    axios
      .get(STORE_ORDER_DETAILS_URL + orderId, {
        headers: {
          Signature: signature,
        },
      })
...
export const getBrandsForFilters = (token, phone) => {
  return dispatch => {
    ...
    const signature = encode(signatureString);
    console.log(
      'STORE get brands for filters',
      signature,
      STORE_BRANDS_FOR_FILTERS_URL,
    );
    axios
      .get(STORE_BRANDS_FOR_FILTERS_URL, {
        headers: {
          Signature: signature,
        },
      })
...
export const updateBasketInfo = (token, phone, basket) => {
  return dispatch => {
    ...
    axios
      .post(STORE_PRODUCT_UPDATE, data, {
        headers: {
          Signature: signature,
          'Content-Type': 'application/json',
        },
